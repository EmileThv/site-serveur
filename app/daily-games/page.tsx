  ...
  return (
    <main className="min-h-screen bg-discord-dark py-16 px-6">
      ...
      <div className="text-center mb-24">
        <h1 className="font-(family-name:--font-squidwod) text-main-green text-8xl md:text-9xl drop-shadow-[0_0_25px_rgba(34,176,78,0.5)] uppercase tracking-tighter">
          Games
        </h1>
        <div className="h-1 w-32 bg-main-green mx-auto mt-4 opacity-50"></div>
      </div>
      ...
      <div className="max-w-none mx-auto flex flex-col gap-24">
        ...
        <section className="flex flex-col items-center">
          <h2 className="font-black text-4xl uppercase tracking-tighter text-white mb-12 border-b-4 border-main-green pb-2">
            Daily Games
          </h2>
          ...
          <div className="flex flex-col md:flex-row justify-center gap-16 md:gap-32 w-full">
            {gamesData.dailyCategories.map((cat) => (
              <div key={cat.nom} className="flex flex-col items-center md:items-start gap-4">
                <h3 className="text-main-green text-sm font-black uppercase tracking-[0.2em] opacity-80 mb-2">
                  {cat.nom}
                </h3>
                <nav className="flex flex-col gap-4">
                  {cat.jeux.map((jeu) => (
                    <a 
                      ...
                      className="group text-gray-300 hover:text-main-green text-3xl font-bold flex items-center gap-2 transition-all duration-300 hover:translate-x-2"
                    >
                      <span className="text-main-green opacity-0 group-hover:opacity-100 transition-opacity font-black">-</span>
                      {jeu.name}
                    </a>
                  ))}
                </nav>
